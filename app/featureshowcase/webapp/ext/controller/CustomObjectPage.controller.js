sap.ui.define([
	...
	return PageController.extend("featureshowcase.ext.controller.CustomObjectPage", {
		onInit: function () {
			PageController.prototype.onInit.apply(this);

			var oModel = new JSONModel(sap.ui.require.toUrl("featureshowcase/ext/controller/data.json"));
			var that = this;
